    ...
    */
    ...
    var decimalFraccionario = function()
    {
        ...
        */
        ...
        var longitud = String(datosDecimal.decimal).length;
        var multiplicar = Math.pow(10,longitud);

        var fraccion = ((datosDecimal.entero * multiplicar) + datosDecimal.decimal) + "/" + multiplicar;
        var txt = simplificaFraccionario(fraccion);
        nom_div("resFraccionario").innerHTML = txt;
    };
    ...
    */
    ...
    var binarioDecimal = function()
    {
        ...
        */
        ...
        var decimal=0;
        var num_caja=numeroInputs;
        for(var i = 1; i <= numeroInputs; i++)
        {
            if(nom_div("valor_" + num_caja).value == 1)
