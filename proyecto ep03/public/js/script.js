		...
		consumeServicios(2, validaRespuesta, function(data)
		{
			...
			$("#mensaje").html(data.correcto ? "CORRECTO :)" : "INCORRECTO :(")
						 ...
						 .hide('fast', function()
						 {
							...
							if(correctas > 8)
						 				mensaje= "No hay mas preguntas, Respuestas correctas = "+correctas+"/10 :D felicidades!";

					 		if(correctas > 5 && correctas < 9)
					 			mensaje = "No hay mas preguntas, Respuestas correctas = "+correctas+"/10 :) bien!";

					 		if(correctas < 6)
				 				mensaje = "No hay mas preguntas, Respuestas correctas = "+correctas+"/10 :(";
